...
def XR_imaris_conversion_data_wrapper(dataPaths, **kwargs):
    ...
    XR_imaris_conversion_data_wrapper_dict = {
        ...
        "converterPath": [kwargs.get("converterPath", f"{os.path.dirname(os.path.abspath(__file__))}/PetaKit5D"
                                                      f"/microscopeDataProcessing/tools/Imaris/Parallel_Imaris_Writer"
                                                      f"/linux/parallelimariswriter"), "char"],
